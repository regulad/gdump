...
LABEL org.opencontainers.image.title="gdump"
LABEL org.opencontainers.image.version="0.1.0"
LABEL org.opencontainers.image.url="https://github.com/regulad/gdump"
LABEL org.opencontainers.image.documentation="https://gdump.readthedocs.io"
...
COPY --from=builder /code/dist/gdump-*.whl /tmp/
RUN pip install --user /tmp/gdump-*.whl

# Now do something!
CMD ["/home/gdump/.local/bin/gdump"]
