"""Metadata for Genesis Dumper - 📆 Genesis Dumper lets you dump your schedule from Genesis and turn it into an .ICS file for use in Google Calendar or Outlook.
...
try:
    ...
    __uri__ = ""
    __title__ = "Genesis Dumper"
    __summary__ = "📆 Genesis Dumper lets you dump your schedule from Genesis and turn it into an .ICS file for use in Google Calendar or Outlook"
    __license__ = "GPL-3.0"
    __version__ = "0.0.0"
